        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 wonderful-title px-5 text-center">
                    <h1>KANTOR UNIT CABANG</h1>
                    <h5>UPC PASAR CITAYAM</h5>
                    <p>KOMPLEKS RUKO CITAYAM PERMAI 30, Bojong Pondok Terong, Pancoran Mas</p>
                    <p>Depok, Jawa Barat</p>
                    <p>Telp. 02187985764 HP. </p>
